-- TERMINALS
-- TERMINALS
INSERT INTO terminal (name, city, country, street, building_number, postcode, latitude, longitude, is_main, created_at) VALUES
    ('Prague Main Station', 'Prague', 'Czech Republic', 'Wilsonova', '300/8', '11000', 50.0833, 14.4333, true, NOW()),
    ('Prague Florenc', 'Prague', 'Czech Republic', 'Pod výtopnou', '13/10', '18600', 50.0895, 14.4402, false, NOW()),
    ('Prague Na Knížecí', 'Prague', 'Czech Republic', 'Nádražní', '25', '15000', 50.0682, 14.4053, false, NOW()),
    ('Brno Central', 'Brno', 'Czech Republic', 'Benešova', '10', '60200', 49.1951, 16.6068, true, NOW()),
    ('Brno Zvonařka', 'Brno', 'Czech Republic', 'Zvonařka', '411', '60200', 49.1865, 16.6152, false, NOW()),
    ('Ostrava Svinov', 'Ostrava', 'Czech Republic', 'Peterkova', '79', '72100', 49.8211, 18.2091, false, NOW()),
    ('Ostrava Central', 'Ostrava', 'Czech Republic', 'Vítkovická', '3', '70200', 49.8291, 18.2812, true, NOW()),
    ('Plzeň Central', 'Plzeň', 'Czech Republic', 'Husova', '2', '30100', 49.7468, 13.3675, true, NOW()),
    ('Liberec Central', 'Liberec', 'Czech Republic', 'Žitavská', '12', '46007', 50.7615, 15.0511, true, NOW()),
    ('Olomouc Central', 'Olomouc', 'Czech Republic', 'Sladkovského', '31', '77900', 49.5912, 17.2785, true, NOW()),
    ('Vienna International', 'Vienna', 'Austria', 'Erdbergstraße', '200', '1030', 48.1920, 16.3920, false, NOW()),
    ('Vienna Hauptbahnhof', 'Vienna', 'Austria', 'Wiedner Gürtel', '14', '1100', 48.1852, 16.3761, true, NOW()),
    ('Vienna Westbahnhof', 'Vienna', 'Austria', 'Europaplatz', '2', '1150', 48.1968, 16.3375, false, NOW()),
    ('Salzburg Central', 'Salzburg', 'Austria', 'Südtiroler Platz', '1', '5020', 47.8128, 13.0456, true, NOW()),
    ('Graz Central', 'Graz', 'Austria', 'Europaplatz', '4', '8020', 47.0728, 15.4167, true, NOW()),
    ('Innsbruck Central', 'Innsbruck', 'Austria', 'Südtiroler Platz', '7', '6020', 47.2631, 11.4011, true, NOW()),
    ('Budapest Népliget', 'Budapest', 'Hungary', 'Üllői út', '131', '1091', 47.4767, 19.0850, true, NOW()),
    ('Budapest Kelenfold', 'Budapest', 'Hungary', 'Etele tér', '7', '1119', 47.4645, 19.0221, false, NOW()),
    ('Budapest Stadionok', 'Budapest', 'Hungary', 'Hungária körút', '48', '1143', 47.5011, 19.1022, false, NOW()),
    ('Debrecen Bus Station', 'Debrecen', 'Hungary', 'Külsővásártér', '12', '4025', 47.5256, 21.6192, true, NOW()),
    ('Szeged Bus Station', 'Szeged', 'Hungary', 'Mars tér', '5', '6724', 46.2582, 20.1412, true, NOW()),
    ('Pecs Bus Station', 'Pecs', 'Hungary', 'Nagy Lajos király útja', '16', '7622', 46.0712, 18.2301, true, NOW()),
    ('Bratislava Mlynské Nivy', 'Bratislava', 'Slovakia', 'Mlynské nivy', '31', '82109', 48.1486, 17.1377, true, NOW()),
    ('Bratislava Petrzalka', 'Bratislava', 'Slovakia', 'Einsteinova', '18', '85101', 48.1315, 17.1001, false, NOW()),
    ('Košice Bus Station', 'Košice', 'Slovakia', 'Staničné námestie', '9', '04001', 48.7212, 21.2675, true, NOW()),
    ('Zilina Bus Station', 'Zilina', 'Slovakia', 'M. R. Štefánika', '56', '01001', 49.2234, 18.7456, true, NOW()),
    ('Warsaw Zachodnia', 'Warsaw', 'Poland', 'Al. Jerozolimskie', '144', '02-305', 52.2189, 20.9652, false, NOW()),
    ('Warsaw Wschodnia', 'Warsaw', 'Poland', 'Lubelska', '22', '03-802', 52.2515, 21.0612, false, NOW()),
    ('Warsaw Central', 'Warsaw', 'Poland', 'Al. Jerozolimskie', '54', '00-024', 52.2289, 21.0035, true, NOW()),
    ('Kraków Central', 'Kraków', 'Poland', 'Bosacka', '18', '31-505', 50.0685, 19.9492, true, NOW()),
    ('Gdańsk Central', 'Gdańsk', 'Poland', '3 Maja', '12', '80-802', 54.3541, 18.6433, true, NOW()),
    ('Wrocław Central', 'Wrocław', 'Poland', 'Sucha', '1', '50-086', 51.0975, 17.0333, true, NOW()),
    ('Poznań Central', 'Poznań', 'Poland', 'Stanisława Matyi', '2', '61-586', 52.4012, 16.9189, true, NOW()),
    ('Katowice Sadowa', 'Katowice', 'Poland', 'Sądowa', '5', '40-078', 50.2592, 19.0112, true, NOW()),
    ('Łódź Fabryczna', 'Łódź', 'Poland', 'Plac Bronisława Sałacińskiego', '1', '90-001', 51.7695, 19.4682, true, NOW()),
    ('Szczecin Central', 'Szczecin', 'Poland', 'Plac Grodnicki', '1', '70-220', 53.4189, 14.5501, true, NOW()),
    ('Berlin ZOB', 'Berlin', 'Germany', 'Masurenallee', '4', '14057', 52.5075, 13.2792, true, NOW()),
    ('Berlin Ostbahnhof', 'Berlin', 'Germany', 'Koppenstraße', '3', '10243', 52.5103, 13.4344, false, NOW()),
    ('Berlin Sudkreuz', 'Berlin', 'Germany', 'General-Pape-Straße', '1', '12101', 52.4761, 13.3642, false, NOW()),
    ('Munich ZOB', 'Munich', 'Germany', 'Arnulfstraße', '21', '80335', 48.1425, 11.5492, true, NOW()),
    ('Munich Frottmaning', 'Munich', 'Germany', 'Werner-Heisenberg-Allee', '21', '80939', 48.2201, 11.6312, false, NOW()),
    ('Hamburg ZOB', 'Hamburg', 'Germany', 'Adenauerallee', '78', '20097', 53.5522, 10.0133, true, NOW()),
    ('Frankfurt Central', 'Frankfurt', 'Germany', 'Stuttgarter Straße', '26', '60329', 50.1039, 8.6621, true, NOW()),
    ('Frankfurt Airport', 'Frankfurt', 'Germany', 'Hugo-Eckener-Ring', '1', '60549', 50.0515, 8.5701, false, NOW()),
    ('Cologne Central', 'Cologne', 'Germany', 'Breslauer Platz', '1', '50668', 50.9429, 6.9602, true, NOW()),
    ('Cologne Airport', 'Cologne', 'Germany', 'Waldstraße', '247', '51147', 50.8791, 7.1205, false, NOW()),
    ('Stuttgart Airport', 'Stuttgart', 'Germany', 'Busterminal Messe Ost', '1', '70629', 48.6922, 9.1956, true, NOW()),
    ('Stuttgart Oberturkheim', 'Stuttgart', 'Germany', 'Im Degen', '3', '70327', 48.7761, 9.2701, false, NOW()),
    ('Dresden Central', 'Dresden', 'Germany', 'Bayrische Straße', '14', '01069', 51.0392, 13.7322, true, NOW()),
    ('Nuremberg Central', 'Nuremberg', 'Germany', 'Adbertstraße', '2', '90402', 49.4461, 11.0822, true, NOW()),
    ('Leipzig Central', 'Leipzig', 'Germany', 'Brandenburger Straße', '2', '04103', 51.3452, 12.3842, true, NOW()),
    ('Dusseldorf Central', 'Dusseldorf', 'Germany', 'Worringer Straße', '1', '40210', 51.2268, 6.7952, true, NOW()),
    ('Bremen Central', 'Bremen', 'Germany', 'Breitenweg', '3', '28195', 53.0829, 8.8142, true, NOW()),
    ('Hanover Central', 'Hanover', 'Germany', 'Rundestraße', '12', '30161', 52.3789, 9.7429, true, NOW()),
    ('Paris Bercy Seine', 'Paris', 'France', 'Rue de Bercy', '210', '75012', 48.8356, 2.3802, true, NOW()),
    ('Paris Gallieni', 'Paris', 'France', 'Avenue du Général de Gaulle', '28', '93170', 48.8641, 2.4189, false, NOW()),
    ('Paris Pont de Levallois', 'Paris', 'France', 'Place du Maréchal de Lattre de Tassigny', '1', '92300', 48.8982, 2.2885, false, NOW()),
    ('Marseille Saint-Charles', 'Marseille', 'France', 'Square Narvik', '1', '13001', 43.3028, 5.3805, true, NOW()),
    ('Marseille Airport', 'Marseille', 'France', 'Busterminal MP2', '1', '13727', 43.4362, 5.2152, false, NOW()),
    ('Lyon Perrache', 'Lyon', 'France', 'Cours de Verdun', '14', '69002', 45.7489, 4.8252, true, NOW()),
    ('Lyon Part-Dieu', 'Lyon', 'France', 'Rue de la Villette', '18', '69003', 45.7602, 4.8601, false, NOW()),
    ('Toulouse Central', 'Toulouse', 'France', 'Boulevard Pierre Semard', '64', '31500', 43.6128, 1.4542, true, NOW()),
    ('Nice Airport', 'Nice', 'France', 'Terminal 1 Bus Station', '1', '06200', 43.6652, 7.2152, false, NOW()),
    ('Nice Central', 'Nice', 'France', 'Avenue Thiers', '10', '06000', 43.7042, 7.2612, true, NOW()),
    ('Strasbourg Place de l''Etoile', 'Strasbourg', 'France', 'Place de l''Étoile', '1', '67000', 48.5742, 7.7522, true, NOW()),
    ('Bordeaux Saint-Jean', 'Bordeaux', 'France', 'Rue Charles Domercq', '137', '33800', 44.8256, -0.5562, true, NOW()),
    ('Lille Europe', 'Lille', 'France', 'Boulevard de Turin', '1', '59777', 50.6392, 3.0752, true, NOW()),
    ('Nantes Central', 'Nantes', 'France', 'Route de Paris', '21', '44300', 47.2412, -1.5202, true, NOW()),
    ('Madrid Estacion Sur', 'Madrid', 'Spain', 'Calle de Méndez Álvaro', '83', '28045', 40.3956, -3.6792, true, NOW()),
    ('Madrid Avenida de America', 'Madrid', 'Spain', 'Avenida de América', '9', '28002', 40.4382, -3.6761, false, NOW()),
    ('Madrid Aeropuerto Barajas', 'Madrid', 'Spain', 'Terminal 4 Bus Area', '1', '28042', 40.4912, -3.5932, false, NOW()),
    ('Barcelona Nord', 'Barcelona', 'Spain', 'Carrer d''Alí Bei', '80', '08013', 41.3934, 2.1822, true, NOW()),
    ('Barcelona Sants', 'Barcelona', 'Spain', 'Carrer de Viriat', '12', '08014', 41.3792, 2.1402, false, NOW()),
    ('Valencia Central', 'Valencia', 'Spain', 'Carrer de Menéndez Pidal', '11', '46009', 39.4801, -0.3892, true, NOW()),
    ('Seville Plaza de Armas', 'Seville', 'Spain', 'Avenida de Cristo de la Expiración', '2', '41001', 37.3912, -6.0022, true, NOW()),
    ('Zaragoza Delicias', 'Zaragoza', 'Spain', 'Avenida de Navarra', '180', '50011', 41.6592, -0.9122, true, NOW()),
    ('Malaga Central', 'Malaga', 'Spain', 'Paseo de los Tilos', '21', '29006', 36.7128, -4.4322, true, NOW()),
    ('Bilbao Intermodal', 'Bilbao', 'Spain', 'Gurtubay Kalea', '1', '48013', 43.2612, -2.9502, true, NOW()),
    ('Riga Bus Station', 'Riga', 'Latvia', 'Prāgas iela', '1', 'LV-1050', 56.9456, 24.1152, true, NOW()),
    ('Riga Airport', 'Riga', 'Latvia', 'Mārupes pagasts', '1', 'LV-1053', 56.9228, 23.9782, false, NOW()),
    ('Daugavpils Bus Station', 'Daugavpils', 'Latvia', 'Viestura iela', '10', 'LV-5401', 55.8712, 26.5201, true, NOW()),
    ('Liepaja Bus Station', 'Liepaja', 'Latvia', 'Rīgas iela', '71', 'LV-3401', 56.5189, 21.0152, true, NOW()),
    ('Vilnius Bus Station', 'Vilnius', 'Lithuania', 'Sodų g.', '22', 'LT-03211', 54.6712, 25.2822, true, NOW()),
    ('Vilnius Airport', 'Vilnius', 'Lithuania', 'Rodūnios kelias', '10', 'LT-02189', 54.6428, 25.2782, false, NOW()),
    ('Kaunas Bus Station', 'Kaunas', 'Lithuania', 'Vytauto pr.', '24', 'LT-44355', 54.8892, 23.9292, true, NOW()),
    ('Klaipeda Bus Station', 'Klaipeda', 'Lithuania', 'Butkų Juzės g.', '9', 'LT-92228', 55.7189, 21.1456, true, NOW()),
    ('Sofia Central Bus Station', 'Sofia', 'Bulgaria', 'Knyaginya Maria Luiza Blvd', '100', '1202', 42.7128, 23.3212, true, NOW()),
    ('Sofia Serdika', 'Sofia', 'Bulgaria', 'Pl. Predgarov', '1', '1202', 42.7115, 23.3201, false, NOW()),
    ('Plovdiv South Bus Station', 'Plovdiv', 'Bulgaria', 'Hristo Botev Blvd', '47', '4000', 42.1382, 24.7492, true, NOW()),
    ('Varna Bus Station', 'Varna', 'Bulgaria', 'Vladislav Varnenchik Blvd', '158', '9000', 43.2189, 27.8992, true, NOW()),
    ('Zagreb Bus Station', 'Zagreb', 'Croatia', 'Avenija Marina Držića', '4', '10000', 45.8042, 15.9968, true, NOW()),
    ('Split Bus Station', 'Split', 'Croatia', 'Obala Kneza Domagoja', '12', '21000', 43.5042, 16.4429, true, NOW()),
    ('Dubrovnik Bus Station', 'Dubrovnik', 'Croatia', 'Obala Ivana Pavla II', '44', '20000', 42.6612, 18.0805, true, NOW()),
    ('Rijeka Bus Station', 'Rijeka', 'Croatia', 'Trg Žabica', '1', '51000', 45.3289, 14.4377, true, NOW()),
    ('Ljubljana Bus Station', 'Ljubljana', 'Slovenia', 'Trg Osvobodilne Fronte', '4', '1000', 46.0582, 14.5112, true, NOW()),
    ('Maribor Bus Station', 'Maribor', 'Slovenia', 'Mlinska ulica', '1', '2000', 46.5592, 15.6542, true, NOW()),
    ('Koper Bus Station', 'Koper', 'Slovenia', 'Kolodvorska cesta', '11', '6000', 45.5412, 13.7382, true, NOW()),
    ('Rome Tiburtina', 'Rome', 'Italy', 'Piazzale della Stazione Tiburtina', '1', '00162', 41.9102, 12.5292, true, NOW()),
    ('Rome Anagnina', 'Rome', 'Italy', 'Piazzale dell''Anagnina', '10', '00173', 41.8415, 12.5852, false, NOW()),
    ('Milan Lampugnano', 'Milan', 'Italy', 'Via Giulio Natta', '226', '20151', 45.4895, 9.1275, true, NOW()),
    ('Milan Rogoredo', 'Milan', 'Italy', 'Via Rogoredo', '83', '20138', 45.4292, 9.2392, false, NOW()),
    ('Venice Mestre', 'Venice', 'Italy', 'Viale Stazione', '21', '30171', 45.4828, 12.2312, true, NOW()),
    ('Venice Tronchetto', 'Venice', 'Italy', 'Isola del Tronchetto', '1', '30135', 45.4412, 12.3082, false, NOW()),
    ('Florence Villa Constanza', 'Florence', 'Italy', 'Via della Costituzione', '1', '50018', 43.7542, 11.1712, true, NOW()),
    ('Naples Metropark', 'Naples', 'Italy', 'Corso Arnaldo Lucci', '1', '80142', 40.8512, 14.2742, true, NOW()),
    ('Amsterdam Sloterdijk', 'Amsterdam', 'Netherlands', 'Radarweg', '36', '1043 NX', 52.3892, 4.8377, true, NOW()),
    ('Amsterdam Bijlmer Arena', 'Amsterdam', 'Netherlands', 'Hoogoorddreef', '3', '1101 BA', 52.3128, 4.9492, false, NOW()),
    ('Rotterdam Central', 'Rotterdam', 'Netherlands', 'Conradstraat', '18', '3013 AP', 51.9242, 4.4701, true, NOW()),
    ('The Hague Central', 'The Hague', 'Netherlands', 'Prins Bernhardviaduct', '1', '2595 AM', 52.0812, 4.3252, true, NOW()),
    ('Brussels North', 'Brussels', 'Belgium', 'Rue du Progrès', '85', '1210', 50.8605, 4.3592, true, NOW()),
    ('Brussels South', 'Brussels', 'Belgium', 'Rue de France', '2', '1060', 50.8356, 4.3352, false, NOW()),
    ('Antwerp Central', 'Antwerp', 'Belgium', 'Koningin Astridplein', '27', '2018', 51.2189, 4.4212, true, NOW()),
    ('Bruges Station', 'Bruges', 'Belgium', 'Stationsplein', '1', '8000', 51.1982, 3.2189, true, NOW()),
    ('Zurich Carparkplatz', 'Zurich', 'Switzerland', 'Ausstellungsstrasse', '5', '8005', 47.3801, 8.5392, true, NOW()),
    ('Zurich Airport', 'Zurich', 'Switzerland', 'Busterminal', '1', '8058', 47.4512, 8.5612, false, NOW()),
    ('Geneva Bus Station', 'Geneva', 'Switzerland', 'Place Dorcière', '1', '1201', 46.2092, 6.1501, true, NOW()),
    ('Basel SBB', 'Basel', 'Switzerland', 'Meret Oppenheim-Strasse', '40', '4053', 47.5468, 7.5892, true, NOW()),
    ('London Victoria', 'London', 'United Kingdom', 'Buckingham Palace Road', '164', 'SW1W 9TP', 51.4922, -0.1485, true, NOW()),
    ('Manchester Central', 'Manchester', 'United Kingdom', 'Chorlton Street', '55', 'M1 3JF', 53.4789, -2.2382, true, NOW()),
    ('Birmingham Coach Station', 'Birmingham', 'United Kingdom', 'Mill Lane', '1', 'B5 6DD', 52.4761, -1.8901, true, NOW()),
    ('Lisbon Sete Rios', 'Lisbon', 'Portugal', 'Praça Marechal Humberto Delgado', '1', '1500-423', 38.7412, -9.1662, true, NOW()),
    ('Lisbon Oriente', 'Lisbon', 'Portugal', 'Av. Dom João II', '1', '1990-233', 38.7678, -9.0982, false, NOW()),
    ('Porto Campo 24 de Agosto', 'Porto', 'Portugal', 'Campo de 24 de Agosto', '125', '4300-096', 41.1492, -8.5992, true, NOW()),
    ('Copenhagen Ingerslevsgade', 'Copenhagen', 'Denmark', 'Ingerslevsgade', '1', '1700', 55.6692, 12.5642, true, NOW()),
    ('Aarhus Bus Station', 'Aarhus', 'Denmark', 'Valdemarsgade', '9', '8000', 56.1512, 10.2012, true, NOW()),
    ('Stockholm Cityterminalen', 'Stockholm', 'Sweden', 'Klarabergsviadukten', '72', '111 64', 59.3308, 18.0568, true, NOW()),
    ('Gothenburg Nils Ericson', 'Gothenburg', 'Sweden', 'Nils Ericsonsplatsen', '7', '411 03', 57.7092, 11.9722, true, NOW()),
    ('Oslo Bussterminal', 'Oslo', 'Norway', 'Schweigaards gate', '10', '0185', 59.9112, 10.7582, true, NOW()),
    ('Bergen Bussterminal', 'Bergen', 'Norway', 'Fjøsangerveien', '4', '5008', 60.3892, 5.3333, true, NOW()),
    ('Helsinki Kamppi', 'Helsinki', 'Finland', 'Urho Kekkosen katu', '1', '00100', 60.1692, 24.9322, true, NOW()),
    ('Tampere Bus Station', 'Tampere', 'Finland', 'Hatanpään valtatie', '7', '33100', 61.4912, 23.7712, true, NOW()),
    ('Tallinn Central', 'Tallinn', 'Estonia', 'Lastekodu', '46', '10144', 59.4282, 24.7733, true, NOW()),
    ('Tartu Bus Station', 'Tartu', 'Estonia', 'Turu', '2', '51013', 58.3782, 26.7322, true, NOW()),
    ('Bucharest Filaret', 'Bucharest', 'Romania', 'Piața Gara Filaret', '1', '040331', 44.4142, 26.0935, true, NOW()),
    ('Bucharest Militari', 'Bucharest', 'Romania', 'Valea Cascadelor', '1', '061501', 44.4312, 26.0022, false, NOW()),
    ('Cluj-Napoca Bus Station', 'Cluj-Napoca', 'Romania', 'Strada Giordano Bruno', '1', '400424', 46.7828, 23.5912, true, NOW()),
    ('Timisoara Bus Station', 'Timisoara', 'Romania', 'Calea Stan Vidrighin', '4', '300645', 45.7412, 21.2492, true, NOW()),
    ('Karlovy Vary Terminal', 'Karlovy Vary', 'Czech Republic', 'Západní', '21', '36001', 50.2285, 12.8641, true, NOW()),
    ('Pardubice Central', 'Pardubice', 'Czech Republic', 'Palackého třída', '2020', '53002', 50.0315, 15.7592, true, NOW()),
    ('Gdynia Bus Station', 'Gdynia', 'Poland', 'Plac Konstytucji', '1', '81-354', 54.5212, 18.5292, true, NOW()),
    ('Bialystok Bus Station', 'Bialystok', 'Poland', 'Bohaterów Monte Cassino', '8', '15-879', 53.1333, 23.1412, true, NOW()),
    ('Lublin Bus Station', 'Lublin', 'Poland', 'Al. Tysiąclecia', '6', '20-121', 51.2528, 22.5692, true, NOW()),
    ('Nuremberg Airport', 'Nuremberg', 'Germany', 'Flughafenstraße', '100', '90411', 49.4952, 11.0772, false, NOW()),
    ('Dortmund Central', 'Dortmund', 'Germany', 'Steinstraße', '39', '44137', 51.5202, 7.4612, true, NOW()),
    ('Essen Central', 'Essen', 'Germany', 'Freiheit', '2', '45127', 51.4512, 7.0122, true, NOW()),
    ('Duisburg Central', 'Duisburg', 'Germany', 'Otto-Keller-Straße', '1', '47057', 51.4292, 6.7761, true, NOW()),
    ('Montpellier Sabines', 'Montpellier', 'France', 'Avenue du Colonel Pavelet', '1', '34070', 43.5828, 3.8601, true, NOW()),
    ('Nice Airport T2', 'Nice', 'France', 'Terminal 2 Bus Station', '2', '06200', 43.6612, 7.2082, false, NOW()),
    ('Granada Bus Station', 'Granada', 'Spain', 'Avenida de Juan Pablo II', '88', '18014', 37.2012, -3.6152, true, NOW()),
    ('Alicante Bus Station', 'Alicante', 'Spain', 'Muelle de Poniente', '1', '03001', 38.3382, -0.4902, true, NOW()),
    ('San Sebastian Bus Station', 'San Sebastian', 'Spain', 'Paseo de Federico García Lorca', '1', '20012', 43.3182, -1.9782, true, NOW()),
    ('Zadar Bus Station', 'Zadar', 'Croatia', 'Ante Starčevića', '1', '23000', 44.1082, 15.2412, true, NOW()),
    ('Pula Bus Station', 'Pula', 'Croatia', 'Trg I. istarske brigade', '1', '52100', 44.8761, 13.8542, true, NOW()),
    ('Trnava Bus Station', 'Trnava', 'Slovakia', 'Kollárova', '15', '91701', 48.3712, 17.5892, true, NOW()),
    ('Nitra Bus Station', 'Nitra', 'Slovakia', 'Staničná', '1', '94901', 48.3042, 18.0792, true, NOW()),
    ('Bologna Bus Station', 'Bologna', 'Italy', 'Piazza XX Settembre', '6', '40121', 44.5056, 11.3456, true, NOW()),
    ('Turin Corso Vittorio Emanuele', 'Turin', 'Italy', 'Corso Vittorio Emanuele II', '131', '10138', 45.0682, 7.6582, true, NOW()),
    ('Brasov Bus Station 1', 'Brasov', 'Romania', 'Gării', '1', '500040', 45.6612, 25.6152, true, NOW()),
    ('Constanta Bus Station', 'Constanta', 'Romania', 'Theodor Burada', '1', '900178', 44.1792, 28.6292, true, NOW()),
    ('Kyiv Central Bus Station', 'Kyiv', 'Ukraine', 'Nauky Ave', '1/2', '03039', 50.4022, 30.5218, true, NOW()),
    ('Kyiv Vydubychi Bus Station', 'Kyiv', 'Ukraine', 'Naberezhno-Pecherska Rd', '10', '01014', 50.4024, 30.5606, false, NOW()),
    ('Lviv Central Bus Station', 'Lviv', 'Ukraine', 'Stryiska St', '109', '79031', 49.7850, 24.0150, true, NOW()),
    ('Lviv Railway Station Bus Stop', 'Lviv', 'Ukraine', 'Dvirtseva Square', '1', '79018', 49.8397, 23.9944, false, NOW()),
    ('Kharkiv Central Bus Station', 'Kharkiv', 'Ukraine', 'Gagarin Ave', '22', '61001', 49.9808, 36.2442, true, NOW())
...
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Madrid - Lisbon - Porto' AND t.name = 'Madrid Estacion Sur'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 409, 419, 498.3, 54.81 FROM route r, terminal t WHERE r.name = 'Madrid - Lisbon - Porto' AND t.name = 'Lisbon Oriente'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 424, 434, 504.9, 55.54 FROM route r, terminal t WHERE r.name = 'Madrid - Lisbon - Porto' AND t.name = 'Lisbon Sete Rios'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 652, 652, 777.0, 85.47 FROM route r, terminal t WHERE r.name = 'Madrid - Lisbon - Porto' AND t.name = 'Porto Campo 24 de Agosto'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
...
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Aarhus - Copenhagen - Gothenburg - Stockholm - Oslo' AND t.name = 'Aarhus Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 135, 145, 156.7, 17.24 FROM route r, terminal t WHERE r.name = 'Aarhus - Copenhagen - Gothenburg - Stockholm - Oslo' AND t.name = 'Copenhagen Ingerslevsgade'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 329, 339, 386.4, 42.50 FROM route r, terminal t WHERE r.name = 'Aarhus - Copenhagen - Gothenburg - Stockholm - Oslo' AND t.name = 'Gothenburg Nils Ericson'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 656, 666, 782.9, 86.12 FROM route r, terminal t WHERE r.name = 'Aarhus - Copenhagen - Gothenburg - Stockholm - Oslo' AND t.name = 'Stockholm Cityterminalen'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 5, 998, 998, 1198.1, 131.79 FROM route r, terminal t WHERE r.name = 'Aarhus - Copenhagen - Gothenburg - Stockholm - Oslo' AND t.name = 'Oslo Bussterminal'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Bergen - Oslo - Stockholm' AND t.name = 'Bergen Bussterminal'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 254, 264, 304.8, 33.53 FROM route r, terminal t WHERE r.name = 'Bergen - Oslo - Stockholm' AND t.name = 'Oslo Bussterminal'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 596, 596, 720.0, 79.20 FROM route r, terminal t WHERE r.name = 'Bergen - Oslo - Stockholm' AND t.name = 'Stockholm Cityterminalen'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Tampere - Helsinki - Tallinn - Tartu - Riga - Vilnius' AND t.name = 'Tampere Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 138, 148, 159.9, 17.59 FROM route r, terminal t WHERE r.name = 'Tampere - Helsinki - Tallinn - Tartu - Riga - Vilnius' AND t.name = 'Helsinki Kamppi'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 214, 224, 242.8, 26.71 FROM route r, terminal t WHERE r.name = 'Tampere - Helsinki - Tallinn - Tartu - Riga - Vilnius' AND t.name = 'Tallinn Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 354, 364, 404.9, 44.54 FROM route r, terminal t WHERE r.name = 'Tampere - Helsinki - Tallinn - Tartu - Riga - Vilnius' AND t.name = 'Tartu Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 5, 542, 552, 627.6, 69.04 FROM route r, terminal t WHERE r.name = 'Tampere - Helsinki - Tallinn - Tartu - Riga - Vilnius' AND t.name = 'Riga Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 6, 735, 745, 856.6, 94.23 FROM route r, terminal t WHERE r.name = 'Tampere - Helsinki - Tallinn - Tartu - Riga - Vilnius' AND t.name = 'Kaunas Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 7, 817, 817, 946.7, 104.14 FROM route r, terminal t WHERE r.name = 'Tampere - Helsinki - Tallinn - Tartu - Riga - Vilnius' AND t.name = 'Vilnius Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Liepaja - Daugavpils - Riga Airport - Vilnius Airport - Vilnius' AND t.name = 'Liepaja Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 288, 298, 348.0, 38.28 FROM route r, terminal t WHERE r.name = 'Liepaja - Daugavpils - Riga Airport - Vilnius Airport - Vilnius' AND t.name = 'Daugavpils Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 454, 464, 543.3, 59.76 FROM route r, terminal t WHERE r.name = 'Liepaja - Daugavpils - Riga Airport - Vilnius Airport - Vilnius' AND t.name = 'Riga Airport'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 677, 687, 809.5, 89.05 FROM route r, terminal t WHERE r.name = 'Liepaja - Daugavpils - Riga Airport - Vilnius Airport - Vilnius' AND t.name = 'Vilnius Airport'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 5, 690, 690, 812.7, 89.40 FROM route r, terminal t WHERE r.name = 'Liepaja - Daugavpils - Riga Airport - Vilnius Airport - Vilnius' AND t.name = 'Vilnius Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
...
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Amsterdam - Rotterdam - Antwerp - Brussels' AND t.name = 'Amsterdam Sloterdijk'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 56, 66, 57.5, 6.33 FROM route r, terminal t WHERE r.name = 'Amsterdam - Rotterdam - Antwerp - Brussels' AND t.name = 'Rotterdam Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 129, 139, 136.0, 14.96 FROM route r, terminal t WHERE r.name = 'Amsterdam - Rotterdam - Antwerp - Brussels' AND t.name = 'Antwerp Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 171, 171, 176.1, 19.37 FROM route r, terminal t WHERE r.name = 'Amsterdam - Rotterdam - Antwerp - Brussels' AND t.name = 'Brussels North'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'The Hague - Amsterdam Bijlmer - Brussels South - Bruges' AND t.name = 'The Hague Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 50, 60, 49.7, 5.47 FROM route r, terminal t WHERE r.name = 'The Hague - Amsterdam Bijlmer - Brussels South - Bruges' AND t.name = 'Amsterdam Bijlmer Arena'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 196, 206, 219.3, 24.12 FROM route r, terminal t WHERE r.name = 'The Hague - Amsterdam Bijlmer - Brussels South - Bruges' AND t.name = 'Brussels South'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 276, 276, 307.2, 33.79 FROM route r, terminal t WHERE r.name = 'The Hague - Amsterdam Bijlmer - Brussels South - Bruges' AND t.name = 'Bruges Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
...
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Sofia - Bucharest - Constanta' AND t.name = 'Sofia Central Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 10, 20, 0.2, 0.02 FROM route r, terminal t WHERE r.name = 'Sofia - Bucharest - Constanta' AND t.name = 'Sofia Serdika'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 251, 261, 288.7, 31.76 FROM route r, terminal t WHERE r.name = 'Sofia - Bucharest - Constanta' AND t.name = 'Bucharest Militari'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 267, 277, 296.2, 32.58 FROM route r, terminal t WHERE r.name = 'Sofia - Bucharest - Constanta' AND t.name = 'Bucharest Filaret'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 5, 440, 440, 499.7, 54.97 FROM route r, terminal t WHERE r.name = 'Sofia - Bucharest - Constanta' AND t.name = 'Constanta Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
...
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Prague - Dresden - Berlin ZOB - Berlin Ostbahnhof' AND t.name = 'Prague Main Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 104, 114, 117.3, 12.90 FROM route r, terminal t WHERE r.name = 'Prague - Dresden - Berlin ZOB - Berlin Ostbahnhof' AND t.name = 'Dresden Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 247, 257, 283.5, 31.18 FROM route r, terminal t WHERE r.name = 'Prague - Dresden - Berlin ZOB - Berlin Ostbahnhof' AND t.name = 'Berlin ZOB'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 265, 265, 294.0, 32.34 FROM route r, terminal t WHERE r.name = 'Prague - Dresden - Berlin ZOB - Berlin Ostbahnhof' AND t.name = 'Berlin Ostbahnhof'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Prague - Brno - Vienna - Bratislava - Budapest' AND t.name = 'Prague Main Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 158, 168, 185.1, 20.36 FROM route r, terminal t WHERE r.name = 'Prague - Brno - Vienna - Bratislava - Budapest' AND t.name = 'Brno Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 259, 269, 298.7, 32.86 FROM route r, terminal t WHERE r.name = 'Prague - Brno - Vienna - Bratislava - Budapest' AND t.name = 'Vienna Hauptbahnhof'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 314, 324, 355.3, 39.08 FROM route r, terminal t WHERE r.name = 'Prague - Brno - Vienna - Bratislava - Budapest' AND t.name = 'Bratislava Mlynské Nivy'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 5, 455, 455, 518.8, 57.07 FROM route r, terminal t WHERE r.name = 'Prague - Brno - Vienna - Bratislava - Budapest' AND t.name = 'Budapest Népliget'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Prague - Wrocław - Łódź - Warsaw - Bialystok' AND t.name = 'Prague Main Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 182, 192, 215.4, 23.69 FROM route r, terminal t WHERE r.name = 'Prague - Wrocław - Łódź - Warsaw - Bialystok' AND t.name = 'Wrocław Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 340, 350, 400.0, 44.00 FROM route r, terminal t WHERE r.name = 'Prague - Wrocław - Łódź - Warsaw - Bialystok' AND t.name = 'Łódź Fabryczna'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 441, 451, 514.0, 56.54 FROM route r, terminal t WHERE r.name = 'Prague - Wrocław - Łódź - Warsaw - Bialystok' AND t.name = 'Warsaw Zachodnia'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 5, 594, 594, 692.5, 76.17 FROM route r, terminal t WHERE r.name = 'Prague - Wrocław - Łódź - Warsaw - Bialystok' AND t.name = 'Bialystok Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Prague - Nuremberg - Frankfurt - Strasbourg - Paris' AND t.name = 'Prague Main Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 211, 221, 250.9, 27.60 FROM route r, terminal t WHERE r.name = 'Prague - Nuremberg - Frankfurt - Strasbourg - Paris' AND t.name = 'Nuremberg Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 372, 382, 439.4, 48.33 FROM route r, terminal t WHERE r.name = 'Prague - Nuremberg - Frankfurt - Strasbourg - Paris' AND t.name = 'Frankfurt Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 528, 538, 621.8, 68.40 FROM route r, terminal t WHERE r.name = 'Prague - Nuremberg - Frankfurt - Strasbourg - Paris' AND t.name = 'Strasbourg Place de l''Etoile'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 5, 854, 864, 1017.0, 111.87 FROM route r, terminal t WHERE r.name = 'Prague - Nuremberg - Frankfurt - Strasbourg - Paris' AND t.name = 'Paris Bercy Seine'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 6, 867, 867, 1021.2, 112.33 FROM route r, terminal t WHERE r.name = 'Prague - Nuremberg - Frankfurt - Strasbourg - Paris' AND t.name = 'Paris Gallieni'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Zurich Airport - Zurich - Basel - Geneva - Lyon - Marseille' AND t.name = 'Prague Main Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 251, 261, 301.0, 33.11 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Zurich Airport - Zurich - Basel - Geneva - Lyon - Marseille' AND t.name = 'Munich ZOB'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 450, 460, 537.0, 59.07 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Zurich Airport - Zurich - Basel - Geneva - Lyon - Marseille' AND t.name = 'Zurich Airport'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 466, 476, 545.1, 59.96 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Zurich Airport - Zurich - Basel - Geneva - Lyon - Marseille' AND t.name = 'Zurich Carparkplatz'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 5, 535, 545, 618.9, 68.08 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Zurich Airport - Zurich - Basel - Geneva - Lyon - Marseille' AND t.name = 'Basel SBB'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 6, 693, 703, 803.5, 88.39 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Zurich Airport - Zurich - Basel - Geneva - Lyon - Marseille' AND t.name = 'Geneva Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 7, 795, 805, 918.0, 100.98 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Zurich Airport - Zurich - Basel - Geneva - Lyon - Marseille' AND t.name = 'Lyon Perrache'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 8, 1025, 1025, 1193.5, 131.28 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Zurich Airport - Zurich - Basel - Geneva - Lyon - Marseille' AND t.name = 'Marseille Saint-Charles'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Milan - Nice - Barcelona - Valencia' AND t.name = 'Prague Main Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 251, 261, 301.0, 33.11 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Milan - Nice - Barcelona - Valencia' AND t.name = 'Munich ZOB'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 539, 549, 648.8, 71.37 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Milan - Nice - Barcelona - Valencia' AND t.name = 'Milan Lampugnano'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 747, 757, 896.3, 98.59 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Milan - Nice - Barcelona - Valencia' AND t.name = 'Nice Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 5, 1151, 1161, 1389.0, 152.79 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Milan - Nice - Barcelona - Valencia' AND t.name = 'Barcelona Sants'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 6, 1402, 1412, 1689.7, 185.87 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Milan - Nice - Barcelona - Valencia' AND t.name = 'Valencia Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 7, 1514, 1514, 1817.0, 199.87 FROM route r, terminal t WHERE r.name = 'Prague - Munich - Milan - Nice - Barcelona - Valencia' AND t.name = 'Alicante Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Prague - Kraków - Lviv - Kyiv Central - Kyiv Vydubychi' AND t.name = 'Prague Main Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 325, 335, 393.5, 43.29 FROM route r, terminal t WHERE r.name = 'Prague - Kraków - Lviv - Kyiv Central - Kyiv Vydubychi' AND t.name = 'Kraków Central'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 569, 579, 686.2, 75.48 FROM route r, terminal t WHERE r.name = 'Prague - Kraków - Lviv - Kyiv Central - Kyiv Vydubychi' AND t.name = 'Lviv Central Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 954, 964, 1155.3, 127.08 FROM route r, terminal t WHERE r.name = 'Prague - Kraków - Lviv - Kyiv Central - Kyiv Vydubychi' AND t.name = 'Kyiv Central Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 5, 966, 966, 1158.1, 127.39 FROM route r, terminal t WHERE r.name = 'Prague - Kraków - Lviv - Kyiv Central - Kyiv Vydubychi' AND t.name = 'Kyiv Vydubychi Bus Station'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 1, 0, 10, 0.0, 0.00 FROM route r, terminal t WHERE r.name = 'Paris Bercy - Lille - Brussels North - London Victoria' AND t.name = 'Paris Bercy Seine'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 2, 175, 185, 206.7, 22.74 FROM route r, terminal t WHERE r.name = 'Paris Bercy - Lille - Brussels North - London Victoria' AND t.name = 'Lille Europe'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 3, 260, 270, 300.3, 33.03 FROM route r, terminal t WHERE r.name = 'Paris Bercy - Lille - Brussels North - London Victoria' AND t.name = 'Brussels North'
ON CONFLICT DO NOTHING;
INSERT INTO route_stop (route_id, terminal_id, sequence_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin, base_price_from_origin)
SELECT r.id, t.id, 4, 528, 528, 622.2, 68.44 FROM route r, terminal t WHERE r.name = 'Paris Bercy - Lille - Brussels North - London Victoria' AND t.name = 'London Victoria'
ON CONFLICT DO NOTHING;
